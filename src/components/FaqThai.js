    ...
    <div className="site-wrap">
          ...
          <div className="row">
            <div className="col-md-4">
              <div className="card ">
                ...
                <h4 className="card-title">เอชพีวี</h4>
              </div>
            </div>
            <div className="col-md-4">
              <div className="card">
      ...
      <div className="faq-sec">
        <div className="container">
          ...
          <div
            className="accordion mb-5 accordion-flush"
            id="faq_accordion_list"
          >
            <div className="accordion-item ">
              ...
              <div
                ...
                data-bs-parent="#faq_accordion_list"
              >
            ...
            <div className="accordion-item all-faq">
              ...
              >
                <div className="accordion-body">
                  โรคติดต่อทางเพศหลายโรคไม่เเสดงอาการหลังได้รับเชื้อ
                  หรืออาจใช้เวลานานก่อนมีอาการ ดังนั้น
                  วิธีเดียวที่จะทราบได้แน่ชัดคือการตรวจหาเชื้อเมื่อมีความเสี่ยง
                  รวมถึงใช้ถุงยางอนามันเพื่อป้องกันการติดเชื้อทุกครั้ง
                </div>
              </div>
            </div>
            <div className="accordion-item all-faq">
              ...
              >
                <div className="accordion-body">
                  การวิจัยพบว่าการเก็บตัวอย่างเซลล์มีความแม่นยำสูงกว่าการใช้ปัสสาวะในการตรวจหาเชื้อเอชพีวี
                  AVA
                  ใช้วิธีการตรวจวิจัยด้วยการเก็บตัวอย่างเซลล์ซึ่งมีความแม่นยำสูงกว่าการใช้ปัสสาวะ
                  เป็นการตรวจที่แนะนำโดย CDC สหรัฐอเมริกา
                  เพื่อตรวจหาการติดเชื้อทางเพศสัมพันธ์โดยเฉพาะเชื้อคลามิเดีย
                  กอนอรีและตริโคโมเนียซิส
                  การเก็บตัวอย่างปัสสาวะอาจผลตรวจเป็นลบที่ไม่ถูกต้องและการติดเชื้อโดยที่ไม่ได้รับการรักษา
                </div>
              </div>
            </div>
            <div className="accordion-item all-faq">
              ...
              >
                <div className="accordion-body">
                  ส่วนที่สำคัญที่สุดในการคุยกับคู่นอนเรื่องการตรวจโรคติดต่อทางเพศสัมพันธ์คือต้องพูดคุยกันด้วยความเข้าใจ
                  ...
                  เข้าไปอ่านเรื่องนี้เพิ่มเติมและละเอียดได้ ในหน้าบทความ{" "}
                </div>
              </div>
            </div>
            <div className="accordion-item all-faq">
              ...
              >
                <div className="accordion-body">
                  ถุงยางอนามัยเป็นวิธีการป้องกันการติดเชื้อทางเพศสัมพันธ์ที่มีประสิทธิภาพ
                  แต่ไม่สามารถป้องกันที่มีประสิทธิภาพ 100% ได้เสมอ
                  เนื่องจากการติดเชื้อทางเพศสัมพันธ์สามารถเกิดขึ้นผ่านการสัมผัสผิวต่อผิว
                  ซึ่งหมายความว่าบริเวณที่ไม่ได้ถูกคลุมโดยถุงยางอนามัย เช่น
                  บริเวณอวัยวะเพศ ยังคงมีความเสี่ยง
                  การเล้าโลมทางเพศก่อนการมีเพศสัมพันธ์ การมีเพศสัมพันธ์ด้วยปาก
                  หรือการใช้ของเล่นทางเพศก็สามารถเป็นสาเหตุให้ติดเชื้อทางเพศสัมพันธ์ได้{" "}
                </div>
              </div>
            </div>
            ...
            <div className="accordion-item hpv">
              <h4 className="accordion-header">
                ...
                >
                  ...
                  ความแตกต่างระหว่างการตรวจ Pap smear, ThinP prep และการตรวจ HPV
                  คืออะไร?
                </button>
              </h4>
              <div
              ...
              >
                <div className="accordion-body">
                  การตรวจ Pap smear
                  หรือการตรวจความเปลี่ยนแปลงของเซลล์บนแผ่นสไลด์แก้ว
                  ส่วนในการตรวจ ThinPrep pap test นั้น
                  จะเก็บตัวอย่างเซลล์โดยใช้แปรงชนิดพิเศษ
                  จากนั้นกรองเซลล์เพื่อล้างสารอื่นๆ
                  ก่อนนำเซลล์มาวางในแผ่นสไลด์แก้วเป็นชั้นบางเพียงชั้นเดียว
                  ในขณะเดียวกัน การคัดกรอง HPV เป็นการตรวจหาเชื้อไวรัสชนิด (HPV)
            ...
            <div className="accordion-item hpv">
              ...
              >
                <div className="accordion-body">
                  ความแม่นยำของผลตรวจขึ้นอยู่กับประสิทธิภาพในการเก็บตัวอย่าง
                  แต่ว่าเรามีวิธีการเก็บตัวอย่างที่ชัดเจน
                  ทำตามได้ง่ายโอกาสผิดผลาดจึงตํ่า
                </div>
              </div>
            </div>
            <div className="accordion-item hpv">
              ...
              >
                <div className="accordion-body">
                  ส่วนใหญ่ของผู้ติดเชื้อ HPV ไม่แสดงอาการใดๆ
                  ดังนั้นการทำการคัดกรองเชื้อ HPV
                  จึงเป็นสิ่งสำคัญในบุคคลที่มีประสบการณ์ทางเพศแล้ว
                  การคัดกรองเชื้อ HPV ช่วยตรวจหาเชื้อ HPV
                  โดยเฉพาะสายพันธุ์ที่มีความเสี่ยงสูง (16 และ 18)
                  ซึ่งมีโอกาสเสี่ยงเป็นมะเร็งปากมดลูกได้
                </div>
              </div>
            </div>
            <div className="accordion-item hpv">
              ...
              >
                <div className="accordion-body">
                  HPV ติดต่อผ่านทางเพศสัมพันธ์
                  สามารถติดต่อได้ทั้งในผู้หญิงเเละผู้ชาย ดังนั้นการคัดกรองเชื้อ
                  HPV จึงจำเป็นสำหรับทั้งผู้ชายและผู้หญิง
                </div>
              </div>
            </div>
            <div className="accordion-item hpv">
              ...
              >
                <div className="accordion-body">
                  เชื้อ HPV มีมากกว่า 100
                  ชนิดและไม่ใช่ทุกชนิดเป็นสาเหตุของมะเร็ง ซึ่งเชื้อ HPV
                  สายพันธุ์ที่ทำให้เกิดโรคมะเร็งปากมดลูกได้สูงที่สุด 2 ชนิด คือ
            ...
            <div className="accordion-item hpv">
              ...
              >
                <div className="accordion-body">
                  มะเร็งปากมดลูกเป็นโรคติดต่อทางเพศสัมพันธ์
                  ไม่ถ่ายทอดทางพันธุกรรม อย่างไรก็ตาม
                  หากมีสมาชิกในตระกูลคนใดเคยเป็นโรคมะเร็ง
                  อาจมีโอกาสพัฒนาเป็นมะเร็งได้ง่ายขึ้น
                </div>
              </div>
            </div>
            <div className="accordion-item hpv">
              ...
              >
                <div className="accordion-body">
                  แม้ผลตรวจ HPV จะเป็นบวก
                  แต่ไม่ได้หมายความว่าเป็นโรคมะเร็งเสมอไป
                  ทั่วไปร่างกายสามารถกำจัดเชื้อ HPV บางสายพันธุ์ได้เอง
                  ขณะเดียวกันบางสายพันธุ์อาจพัฒนาไปเป้นมะเร็ง
                  โดยใช้เวลาสูงสุดถึง 10 ปี
                </div>
              </div>
            </div>
            ...
            <div className="accordion-item sti">
              ...
              >
                <div className="accordion-body">
                  STD หมายถึง “Sexually Transmitted Disease หรือ
                  โรคที่ถ่ายทอดผ่านทางเพศสัมพันธ์” และ STI หมายถึง “Sexually
                  Transmitted Infection หรือ การติดเชื้อทางเพศสัมพันธ์”
                  โดยพื้นฐานแล้ว ผู้คนกำลังพูดถึงสิ่งเดียวกัน:
                  การติดเชื้อที่ถ่ายทอดจากบุคคลหนึ่งไปยังอีกคนผ่านทางเพศสัมพันธ์
                </div>
              </div>
            </div>
            <div className="accordion-item sti">
              ...
              >
                <div className="accordion-body">
                  แนะนำให้ทำการตรวจสอบทุก ๆ 3
                  เดือนสำหรับบุคคลที่มีกิจกรรมทางเพศสม่ำเสมอหรือเปลี่ยนคู่นอนบ่อย
                  อย่างไรก็ตามการตรวจโรคติดต่อทางเพศสัมพันธ์
                  ก่อนเริ่มความสัมพันธ์หรือหลังจบความสัมพันธ์
                  ก็เป็นเรื่องที่น่าคำนึงถึง
                </div>
              </div>
            </div>
            ...
            <div className="accordion-item ava">
              ...
              >
                <div className="accordion-body">
                  ได้โดยซื้อกล่องเอวา กล่องสีเขียวสำหรับการตรวจเชื้อเอชพีวี
                  และสั่งตรวจหาโรคติดต่อทางเพศสัมพันธ์เพิ่มได้บนเว็บไซต์หลังลงทะเบียนชุดตรวจ
                  หรือตัดสินใจสั่งซื้อเพิ่มภายหลังได้รับผลตรวจเอชพีวีก็ได้เช่นกัน
                  *วินเมดเเลปจะเก็บตัวอย่าง 30 วันหลังจากได้รับตัวอย่าง
                </div>
              </div>
            </div>
            <div className="accordion-item ava">
              ...
              >
                <div className="accordion-body">
                  ควรส่งตัวอย่างกลับมาที่วินเมดเเลปให้เร็วที่สุด จะดีที่สุด
                  แต่ไม่ควรเกิน 30 วันหลังจากเก็บตัวอย่าง
                </div>
              </div>
            </div>
            <div className="accordion-item ava">
            ...
            <div className="accordion-item ava">
              ...
              >
                <div className="accordion-body">
                  ไม่ต้องกังวล วิธีการใช้เอวานั้นเข้าใจง่าย
                  เพียงทำตามขั้นตอนที่ระบุไว้
                  และสามารถดูวิดีโอวิธีการใช้งานประกอบร่วมได้
                </div>
              </div>
            </div>
            <div className="accordion-item ava">
              ...
              >
                <div className="accordion-body">
                  ภายในระยะเวลา 7 วันหลังจากตัวอย่างถึงที่วินเมดเเลป
                </div>
              </div>
            </div>
            <div className="accordion-item ava">
